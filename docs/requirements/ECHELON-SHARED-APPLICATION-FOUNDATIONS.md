...
Signal. A missing shared capability MUST be recorded as a gap in the owning
...
**Applicability for Signal: required at GitHub/repository, storage, scoring-expression execution, import/export, browser/WASM, reporting, and other external boundaries.**
...
**Applicability for Signal: required for every interactive browser application surface.**
...
6. Forma owns presentation, tokens, responsive recomposition, visual state cues,
   ...
   behavior beyond native HTML. Signal/Ordo state owns legal transitions,
...
**Applicability for Signal: required for assessment result reports, battery summaries, administrative reports, printable exports, respondent/client deliverables, and other document outputs.**
...
5. Signal owns document data, privacy, authorization, labels, interpretation,
...
- **Signal/Ordo domain state:** authoritative meaning, legal states,
